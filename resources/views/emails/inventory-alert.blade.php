...
<body>
    <div class="email-wrapper">
        ...
        <div class="email-body">
            ...
            <!-- BẢNG 1: LOW STOCK (Đã thêm cột Kho hàng) -->
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th width="25%">Kho hàng</th>
                            <th width="20%" style="text-align: center;">Tồn thực tế</th>
                            <th width="20%">Mức cảnh báo</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Hiển thị tên kho -->
                                <span class="warehouse-name">{{ $item->warehouse_name }}</span>
                            </td>
        ...
        <div class="footer">
            <p style="margin: 0;">Email này được gửi tự động từ Hệ thống Quản lý Kho Mỹ Phẩm.<br>
                ...
                <i>Để tránh làm phiền, các thông báo này sẽ chỉ được lặp lại sau 24h (với tồn kho) và 7 ngày (với hạn sử dụng).</i>
            </p>
        </div>
    </div>
</body>
